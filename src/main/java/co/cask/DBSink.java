...
import co.cask.ETLDBOutputFormat;
...
public class DBSink extends ReferenceBatchSink<StructuredRecord, DBRecord, NullWritable> {
  private static final Logger LOG = LoggerFactory.getLogger(co.cask.hydrator.plugin.db.batch.sink.DBSink.class);
...
//    PhoenixMapReduceUtil.setOutput(job, DBRecord.class, dbSinkConfig.tableName, dbSinkConfig.inputQuery);
...
//  }
  ...
  /**
   * {@link PluginConfig} for {@link co.cask.hydrator.plugin.db.batch.sink.DBSink}
   */
